...
#define LV_USE_LOG 1
    ...
    #if LV_LOG_PRINTF
        #include <stdio.h>
        #define LV_LOG_TRACE(...)  printf(__VA_ARGS__)
        #define LV_LOG_INFO(...)   printf(__VA_ARGS__)
        #define LV_LOG_WARN(...)   printf(__VA_ARGS__)
        #define LV_LOG_ERROR(...)  printf(__VA_ARGS__)
        #define LV_LOG_USER(...)   printf(__VA_ARGS__)
    #endif
#endif
